...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/deepgram-sdk-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/deepgram-sdk-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add deepgram-sdk
# for installing globally
pixi global install deepgram-sdk
```
...
It is possible to list all of the versions of `deepgram-sdk` available on your platform:
...
```
pixi search deepgram-sdk --channel conda-forge
```
